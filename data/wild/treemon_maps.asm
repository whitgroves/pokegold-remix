...
TreeMonMaps:
	...
	treemon_map ROUTE_28,                  TREEMON_SET_CANYON
	...
	treemon_map NEW_BARK_TOWN,             TREEMON_SET_FOREST
	...
	treemon_map CIANWOOD_CITY,             TREEMON_SET_CANYON
	...
	treemon_map SILVER_CAVE_OUTSIDE,       TREEMON_SET_CANYON
