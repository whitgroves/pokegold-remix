...
NidorinaEvosAttacks:
	...
	db EVOLVE_HAPPINESS, TR_ANYTIME, NIDOQUEEN
	db 0 ; no more evolutions
	db 1, GROWL
	db 1, TACKLE
	db 8, SCRATCH
...
NidorinoEvosAttacks:
	...
	db EVOLVE_HAPPINESS, TR_ANYTIME, NIDOKING
	db 0 ; no more evolutions
	db 1, LEER
	db 1, TACKLE
	db 8, HEADBUTT
...
GrowlitheEvosAttacks:
	...
	db EVOLVE_HAPPINESS, TR_ANYTIME, ARCANINE
	db 0 ; no more evolutions
	db 1, GROWL
	db 1, EMBER
	db 9, BITE
...
SlowpokeEvosAttacks:
	...
	db EVOLVE_ITEM, DRAGON_SCALE, SLOWKING
	db 0 ; no more evolutions
	db 1, CURSE
	db 1, TACKLE
	db 6, PSYWAVE
...
SunkernEvosAttacks:
	...
	db EVOLVE_HAPPINESS, TR_MORNDAY, SUNFLORA
	db 0 ; no more evolutions
	db 1, ABSORB
	db 4, GROWTH
	db 10, MEGA_DRAIN
...
PinecoEvosAttacks:
	...
	db EVOLVE_ITEM, LEAF_STONE, FORRETRESS
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, SPIKES
	db 8, BIDE
