...
ScientistGroup:
	...
	db 30, PORYGON,    PSYCH_UP, CONVERSION, RECOVER, PSYBEAM
	db 30, KABUTOPS,   THRASH, RAGE, FURY_CUTTER, NO_MOVE
	db 33, PORYGON2,   PSYCH_UP, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 20, MAGNEMITE,  SUPERSONIC, SONICBOOM, NO_MOVE, NO_MOVE
	db 18, GYARADOS,   THRASH, RAGE, DRAGON_RAGE, OUTRAGE
	db 20, HYPNO,      THRASH, RAGE, DISABLE, NO_MOVE
	db 23, PRIMEAPE,   THRASH, RAGE, FURY_SWIPES, NO_MOVE
	db 29, MUK,    	   THRASH, RAGE, SCREECH, NO_MOVE
...
ExecutiveFGroup:
	...
	db 34, VILEPLUME,  	BEAT_UP, MEGA_DRAIN, SLEEP_POWDER, SWEET_SCENT
