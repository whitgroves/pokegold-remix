...
ChuckGroup:
	...
	db 27, KINGLER,   	CRABHAMMER, ROCK_SMASH, VICEGRIP, METAL_CLAW
	db 28, ELECTABUZZ,	THUNDERPUNCH, MACH_PUNCH, QUICK_ATTACK, DYNAMICPUNCH
	db 29, SUDOWOODO,	ROCK_SLIDE, LOW_KICK, MIMIC, ROCK_SMASH
...
BlackbeltGroup:
	...
	db 28, MACHOKE,    MEDITATE, KARATE_CHOP, FIRE_PUNCH, SEISMIC_TOSS
	db -1 ; end
	...
	db 28, PRIMEAPE,	RAGE, KARATE_CHOP, FURY_SWIPES, THUNDERPUNCH
	db -1 ; end
