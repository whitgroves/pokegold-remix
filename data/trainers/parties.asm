...
MistyGroup:
	...
	db 47, CLOYSTER,   SPIKES, CLAMP, SPIKE_CANNON, RAIN_DANCE
	db 49, GOLDUCK,    SURF, WING_ATTACK, DIG, PSYCHIC_M
	db 45, TENTACRUEL, SURF, RAIN_DANCE, ACID, CLAMP
	db 42, KINGDRA,    SURF, TWISTER, HYPER_BEAM, WATERFALL
	db 44, DEWGONG,    SURF, BLIZZARD, REST, RAIN_DANCE
	db 51, STARMIE,    SURF, PSYCHIC_M, RECOVER, ICE_BEAM
	db -1 ; end
