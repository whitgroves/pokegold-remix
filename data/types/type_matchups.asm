TypeMatchups:
	...
	db ELECTRIC,     PSYCHIC_TYPE, NOT_VERY_EFFECTIVE
	...
	db GROUND,       FIGHTING,     SUPER_EFFECTIVE
	...
	db BUG,          ELECTRIC,     NOT_VERY_EFFECTIVE
	...
	db GHOST,        DRAGON,       SUPER_EFFECTIVE
	db GHOST,        DARK,         NOT_VERY_EFFECTIVE
	db DRAGON,       GRASS,        NOT_VERY_EFFECTIVE
	db DRAGON,       PSYCHIC_TYPE, NOT_VERY_EFFECTIVE
...
; Foresight removes Ghost's immunities.
	...
	db FIGHTING,     GHOST,        NOT_VERY_EFFECTIVE
