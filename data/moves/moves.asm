...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          18, FIGHTING,      85, 15,   0
	...
	move VICEGRIP,     EFFECT_NORMAL_HIT,         55, DARK,         100, 30,   0
	move GUILLOTINE,   EFFECT_OHKO,                0, DARK,          30,  5,   0
	move RAZOR_WIND,   EFFECT_FLINCH_HIT,         80, FLYING,       100, 10,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         50, BUG,          100, 30,   0
	...
	move FLY,          EFFECT_FLY,                80, FLYING,       100, 15,   0
	...
	move SAND_ATTACK,  EFFECT_ACCURACY_DOWN,       0, GROUND,        80, 15,   0
	move HEADBUTT,     EFFECT_FLINCH_HIT,         70, NORMAL,       100, 15,  30
	move HORN_ATTACK,  EFFECT_FLINCH_HIT,         70, DRAGON,       100, 15,  30
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, BUG,           85, 20,   0
	move HORN_DRILL,   EFFECT_OHKO,                1, DRAGON,        30,  5,   0
	move TACKLE,       EFFECT_NORMAL_HIT,         35, NORMAL,       100, 35,   0
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL,       100, 15,  30
	move WRAP,         EFFECT_TRAP_TARGET,        15, POISON,        75, 20,   0
	...
	move ROAR,         EFFECT_FORCE_SWITCH,        0, DRAGON,       100, 20,   0
	...
	move SURF,         EFFECT_ALWAYS_HIT,         95, WATER,        100, 15,   0
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         95, ICE,          100, 10,  10
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,           70,  5,  20
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        120, DRAGON,        90,  5,   0
	...
	move STRENGTH,     EFFECT_ATTACK_UP_HIT,      80, FIGHTING,     100, 15,  10
	move ABSORB,       EFFECT_LEECH_HIT,          30, GRASS,        100, 30,   0
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          50, GRASS,        100, 20,   0
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, GRASS,         90, 10,   0
	move GROWTH,       EFFECT_SP_ATK_UP,           0, GRASS,        100, 40,   0
	...
	move DRAGON_RAGE,  EFFECT_ALWAYS_HIT,         60, DRAGON,       100, 20,   0
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        15, FIRE,          75, 20,   0
	...
	move DIG,          EFFECT_FLY,                60, GROUND,       100, 15,   0
	...
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC_TYPE,  60, 15,   0
	move MEDITATE,     EFFECT_ATTACK_UP,           0, PSYCHIC_TYPE, 100, 40,   0
	move AGILITY,      EFFECT_SPEED_UP_2,          0, NORMAL,       100, 30,   0
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, NORMAL,       100, 30,   0
	move RAGE,         EFFECT_RAGE,               20, DARK,         100, 20,   0
	move TELEPORT,     EFFECT_TELEPORT,            0, PSYCHIC_TYPE, 100, 20,   0
	move NIGHT_SHADE,  EFFECT_SLEEP_HIT,          55, GHOST,        100, 15,  10
	...
	move WITHDRAW,     EFFECT_DEFENSE_CURL,        0, WATER,        100, 40,   0
	...
	move CONSTRICT,    EFFECT_TRAP_TARGET,        15, BUG,           75, 20,   0
	...
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, PSYCHIC_TYPE, 100, 10,  20
	...
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, ROCK,         100, 10,   0
	move REST,         EFFECT_HEAL,                0, NORMAL,       100, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         80, ROCK,         100, 10,  30
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, DARK,         100, 15,  10
	move SHARPEN,      EFFECT_ATTACK_UP,           0, NORMAL,       100, 30,   0
	move CONVERSION,   EFFECT_CONVERSION,          0, NORMAL,       100, 30,   0
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         80, DRAGON,       100, 10,  20
	...
	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FLYING,       100,  5,   0
	...
	move POWDER_SNOW,  EFFECT_EVASION_DOWN_HIT,   40, ICE,          100, 25,  50
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,       100, 10,  50
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  90, WATER,         90, 10,  50
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     55, ICE,          100, 15,  50
	move DETECT,       EFFECT_PROTECT,             0, FIGHTING,     100,  5,   0
	move BONE_RUSH,    EFFECT_MULTI_HIT,          25, ROCK,          80, 10,   0
	move LOCK_ON,      EFFECT_LOCK_ON,             0, STEEL,        100,  5,   0
	...
	move SWAGGER,      EFFECT_SWAGGER,             0, DARK,          90, 15, 100
	...
	move DRAGONBREATH, EFFECT_SP_DEF_DOWN_HIT,    60, DRAGON,       100, 20,  20
	...
	move SWEET_SCENT,  EFFECT_EVASION_DOWN,        0, GRASS,        100, 20,   0
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,         90, 15,  30
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      50, STEEL,        100, 35,  20
	...
	move CRUNCH,       EFFECT_PARALYZE_HIT,       80, DARK,         100, 15,  30
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,         100, 10,  10
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,        100, 15,  20
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      150, PSYCHIC_TYPE, 100,  5,   0
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   40, FIGHTING,     100, 15,  50
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        15, WATER,         75, 20,   0
