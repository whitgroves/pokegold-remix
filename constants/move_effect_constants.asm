; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_OHKO
	const EFFECT_SLEEP_HIT ; previously EFFECT_RAZOR_WIND
	...
	const EFFECT_EVASION_UP_2 ; unused
	...
	const EFFECT_EVASION_DOWN_2 ; unused
	...
	const EFFECT_EVASION_DOWN_HIT ; unused
	...
	const EFFECT_UNUSED_91 ; previously EFFECT_SKULL_BASH
