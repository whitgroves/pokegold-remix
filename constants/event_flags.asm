...
; Johto Gym Leader TM gifts
	const EVENT_GOT_TM31_RAZOR_WIND
...
; HMs
	...
	const_skip ; formely EVENT_GOT_HM06_WHIRLPOOL -- now stored with Johto itemballs
	const EVENT_GOT_HM07_WATERFALL ; formely unused -- HM07 was with Johto itemballs
; Rods
...
; Johto story events
	...
	const EVENT_CLEARED_RADIO_TOWER    ; wEventFlags + 4, bit 1
...
; Kanto story events
	...
	const EVENT_GOT_TM42_BATON_PASS
...
; Johto itemballs
	...
	const EVENT_LAKE_OF_RAGE_TM_ROCK_SLIDE
	...
	const EVENT_TEAM_ROCKET_BASE_B1F_UP_GRADE ; formerly EVENT_TEAM_ROCKET_BASE_B1F_HYPER_POTION
	...
	const EVENT_GOT_HM06_WHIRLPOOL ; formely const EVENT_GOT_HM07_WATERFALL
	...
	const EVENT_DRAGONS_DEN_B1F_DRAGON_SCALE ; previously EVENT_DRAGONS_DEN_B1F_DRAGON_FANG
...
; Johto people
	...
	const EVENT_DRAGONS_DEN_B1F_BLUE_AERODACTYL
	const EVENT_DRAGONS_DEN_B1F_DRAGON_FANG_DROPPED
	const EVENT_MT_SILVER_ARTICUNO
	const EVENT_MT_SILVER_ZAPDOS
	const EVENT_MT_SILVER_MOLTRES
; Kanto people
