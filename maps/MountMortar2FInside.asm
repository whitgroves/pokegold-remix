...
MountMortar2FInside_MapEvents:
	...
	object_event 14,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar2FInsideQuickClaw, EVENT_MOUNT_MORTAR_2F_INSIDE_DRAGON_SCALE
