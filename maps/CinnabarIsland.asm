...
CinnabarIsland_MapEvents:
	...
	object_event  9,  1, SPRITE_MONSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CinnabarIslandMewtwo, EVENT_CINNABAR_ISLAND_MEWTWO
